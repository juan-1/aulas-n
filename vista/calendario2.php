...
<center><h1>CALENDARIO DE RESERVAS</h1></center>
    ...
    <form name="myform" id="myform" action="calendario2.php" method="post">
...
?> 
 <table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%"  border="1">
      ...
      <tfoot>
            <tr>
                <th><center><a href="admin2.php"><img src="media/images/regreso.png"  width="95" height="50" style="margin-top:17px;"></a></center></th>
                <th> </th>
            </tr>
      </table>
<?php
...
var cuenta2=0;
      ...
      if (longitud-cuenta2==1) {
         document.getElementById("example").rows[dia+j].cells[horas+ii].innerHTML ='<a type="submit" href="actualizaRes2.php? clave= <?php echo $row['numero_reserva'] ?>" title="<?php echo $nombre?>" <center><?php echo $resumen.' M' ?></center></a>'; 
      document.getElementById('example').rows[dia+j].cells[horas+ii].style.backgroundColor='<?php echo $micolor ?>';
      }
