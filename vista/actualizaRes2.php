...
<div class="container3">        
  ...
  <form method="post" action="guardareservanueva2.php" id="formreserva">
   ...
   <?php $hoy = date('Y-m-d'); ?>
    ...
    <a href="calendario2.php" ><img src="media/images/regreso.png" width="95" height="50" style="margin-top:17px; margin-left:34px;"></a>

    
 </form>

  <form method="post" action="borrarEvento2.php">
...
<?php }else{ ?> 
    <h2>No puedes Editar esté evento</h2>
    <a href="calendario2.php" ><img src="media/images/regreso.png" width="95" height="50" style="margin-top:17px; margin-left:34px;"></a>
  <?php } ?>   
 </div>
