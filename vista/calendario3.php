...
<html lang="en" >
    <head>
        ...
        <link href="media/css/layout2.css" rel="stylesheet" type="text/css" />
...
<center><h1>CALENDARIO DE RESERVAS</h1></center>
    ...
    <form name="myform" id="myform" action="calendario3.php" method="post">
...
?> 
 <table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%"  border="1">
      ...
      <tfoot>
            <tr>
                <th><center><a href="observador.php"><img src="media/images/regreso.png"  width="95" height="50" style="margin-top:17px;"></a></center></th>
                <th> </th>
            </tr>
      </table>
<?php
...
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ?> 
       ...
       <tr class="success">
       <td style="background-color: #dca80a; color: #000000;font-weight: bold;"><?php echo $i; ?></td> 
       <td style="background-color: #dca80a; color: #000000;font-weight: bold;"><?php echo $array_dias[date('l', strtotime($aux1))];?></td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
