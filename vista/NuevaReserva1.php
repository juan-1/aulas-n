...
<div class="container3">        
  ...
  <form method="post" action="guardareserva.php" id="formreserva">
    ...
    <label>Número de cuenta o CURP:</label><input type="text" name="numsoli" maxlength="16" class="validate[required,custom[onlyLetterNumber]] text-input" placeholder="Numero o CURP del solicitante">
